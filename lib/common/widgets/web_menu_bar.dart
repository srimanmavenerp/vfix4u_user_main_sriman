...
//               onTap: () {
//                 _closeSearchDialog();
//                 Scaffold.of(context).openEndDrawer(); // ✅ correct context inside Builder
//               },
//             );
//           },
//         ),
...
//             return InkWell(
//               onTap: () {
//                 _closeSearchDialog(); Get.find<AllSearchController>().clearSearchController();
...
//                     ),
//                     const SizedBox(width: Dimensions.paddingSizeExtraSmall),
//                     Text(authController.isLoggedIn() ? 'my_bookings'.tr : 'profile'.tr,style: robotoRegular.copyWith(color: Colors.white),),
//                   ],
//                 ),
//               ),
//             );
