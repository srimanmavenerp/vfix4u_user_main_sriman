      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: widget.prefixIcon != null
              ? Padding(
                  ...
                  child: Image.asset(
                    ...
                    width: 20,
                    height: 20,
                    color: const Color(0xffFEFEFE).withValues(alpha: 0.4),
                  ),
                )
              : widget.countryDialCode != null
                  ? Padding(
                      padding: EdgeInsets.only(
                          left: widget.isShowBorder == true ? 10 : 0, top: 0),
                      child: CodePickerWidget(
                        ...
                        showFlagMain: true,
                        dialogSize:
                            Size(Dimensions.webMaxWidth / 2, Get.height * 0.6),
          ...
          focusedBorder: widget.isShowBorder != null && widget.isShowBorder!
              ? OutlineInputBorder(
                  borderSide: BorderSide(color: const Color(0xffFEFEFE)),
          ...
          hintStyle: robotoRegular.copyWith(
              ...
              color: Theme.of(context)
                  .hintColor
                  .withValues(alpha: Get.isDarkMode ? .5 : 1)),
