        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              margin:
                  const EdgeInsets.only(right: Dimensions.paddingSizeLarge * 2),
            ),
            const SizedBox(height: Dimensions.paddingSizeExtraSmall),
            const SizedBox(height: Dimensions.paddingSizeExtraSmall),
            Row(children: [
              Container(
                  height: 10, width: 30, color: Theme.of(context).shadowColor),
              const SizedBox(width: Dimensions.paddingSizeExtraSmall),
              Container(
                  height: 10, width: 20, color: Theme.of(context).shadowColor),
            ]),
            const SizedBox(
              height: Dimensions.paddingSizeSmall,
            ),
