...
Future<Map<String, Map<String, String>>> init() async {
  ...
  /// 🟨 Repositories
  Get.lazyPut(() => NewSubmitReviewRepo(
      apiClient: Get.find(), sharedPreferences: Get.find()));
  Get.lazyPut(() => new_SubmitReviewRepo(
      apiClient: Get.find(), sharedPreferences: Get.find()));
  Get.lazyPut(
  ...
  Get.lazyPut(() => ProviderBookingRepo(
      apiClient: Get.find(), sharedPreferences: Get.find()));
  Get.lazyPut(
  ...
  Get.lazyPut(() =>
      ServiceBookingRepo(sharedPreferences: Get.find(), apiClient: Get.find()));
  Get.lazyPut(() =>
      BookingDetailsRepo(apiClient: Get.find(), sharedPreferences: Get.find()));
