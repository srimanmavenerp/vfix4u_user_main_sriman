...
class _ForgetPassScreenState extends State<ForgetPassScreen> {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Center(
                                  child: Text(
                                '${"verify_your".tr} ${_forgetPasswordMethod == "email" ? "email_address".tr.toLowerCase() : _forgetPasswordMethod == "phone" ? "phone_number".tr.toLowerCase() : "email_phone".tr}',
                            ...
                            Padding(
                              ...
                              child: Center(
                                  child: Text(
                                '${"please_enter_your".tr} ${_forgetPasswordMethod == "email" ? "email_address".tr.toLowerCase() : _forgetPasswordMethod == "phone" ? "phone_number".tr.toLowerCase() : "email_phone".tr} ${"to_receive_a_verification_code".tr}',
  ...
  void _forgetPass(
      String countryDialCode, AuthController authController) async {
