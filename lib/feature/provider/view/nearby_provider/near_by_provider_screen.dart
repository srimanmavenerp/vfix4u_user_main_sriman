...
import 'package:Vfix4u/feature/provider/view/nearby_provider/widget/nearby_provider_tabbar_view.dart';
...
class _NearByProviderScreenState extends State<NearByProviderScreen>
  ...
  _loadDart() async {
    ...
    Get.find<NearbyProviderController>()
        ...
        actionWidget: GetBuilder<NearbyProviderController>(
          ...
          return Padding(
            padding: const EdgeInsets.symmetric(
                horizontal: Dimensions.paddingSizeDefault, vertical: 15),
            child: InkWell(
              onTap: () {
