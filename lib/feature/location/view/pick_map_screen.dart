...
class _PickMapScreenState extends State<PickMapScreen> {
  ...
  void initState() {
    ...
    if (widget.zone != null) {
      _centerLatLng = Get.find<ServiceAreaController>()
          .computeCentroid(coordinates: widget.zone!.formattedCoordinates!);
      _initialPosition =
          LatLng(_centerLatLng!.latitude, _centerLatLng!.longitude);
                            ...
                            onPressed: (locationController.buttonDisabled ||
                                ...
                                : () {
                                    if (locationController
                                            ...
                                            0 &&
                                        locationController
                                            .pickAddress.address!.isNotEmpty) {
                                      if (widget.fromAddAddress!) {
                                        ...
                                        if (kDebugMode) {
                                          print(
                                              "Inside Here ===> Route === > ${widget.route}");
                                        }
                                        locationController
      ...
      return Center(
        child: Stack(
          ...
          children: [
            ...
            Padding(
              padding:
                  const EdgeInsets.only(top: Dimensions.pickMapIconSize * 0.4),
              child: Column(
