...
class _CustomPostCheckoutScreenState extends State<CustomPostCheckoutScreen> {
  ...
  void initState() {
    ...
    Get.find<CartController>()
        .updateWalletPaymentStatus(false, shouldUpdate: false);
    Get.find<CheckOutController>().getOfflinePaymentMethod(true);
    Get.find<CheckOutController>()
        .toggleTerms(value: false, shouldUpdate: false);
  }
                      ...
                      children: [
                        ...
                        DescriptionExpansionTile(
                          ...
                          subTitle: checkoutController
                                  .postDetails?.serviceDescription ??
                              "",
                        ),
                        (checkoutController.postDetails != null &&
                                checkoutController.postDetails!
                                    .additionInstructions!.isNotEmpty)
                            ? DescriptionExpansionTile(
                                title: "additional_instruction",
                                additionalInstruction: checkoutController
                                    .postDetails!.additionInstructions,
                              )
                            : const SizedBox(),
                        const SizedBox(
                        ...
                        Padding(
                          padding: EdgeInsets.symmetric(
                              ...
                              vertical:
                                  ResponsiveHelper.isDesktop(context) ? 15 : 0),
                        ...
                        SizedBox(
                          height:
                              ResponsiveHelper.isDesktop(context) ? 70 : 130,
                        )
                      ],
                    ),
                  ));
  ...
  void _makePayment(
    ...
    bool isPartialPayment = Get.find<CheckOutController>().totalAmount >
    ...
    if (Get.find<CheckOutController>().acceptTerms) {
      if ((addressModel?.contactPersonName == "null" ||
        ...
        customSnackBar("select_another_payment_method_to_pay_remaining_bill".tr,
            type: ToasterMessageType.info);
        ...
        Response response =
            await Get.find<CreatePostController>().updatePostStatus(
          widget.postId,
          widget.providerId,
          'accept',
          isPartial:
        ...
        if (checkoutController.selectedOfflineMethod != null) {
          ...
          Response response =
              await Get.find<CreatePostController>().makePayment(
            postId: widget.postId,
            providerId: widget.providerId,
        ...
        if (checkoutController.selectedDigitalPaymentMethod != null &&
          ...
          String? path = html.window.location.pathname
              ?.replaceAll(RouteHelper.customPostCheckout, "");
          ...
          String encodedAddress =
              base64Encode(utf8.encode(jsonEncode(addressModel.toJson())));
          String addressId =
              (addressModel.id == "null" || addressModel.id == null)
                  ? ""
                  : addressModel.id ?? "";
          ...
          int isPartial =
              cartController.walletPaymentStatus && isPartialPayment ? 1 : 0;
