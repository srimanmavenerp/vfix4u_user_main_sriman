...
class _OfflinePaymentScreenState extends State<OfflinePaymentScreen> {
  ...
  void initState() {
    ...
    scrollController!.scrollToIndex(widget.index ?? 0,
                ...
                ? () {
                    Get.dialog(
                        ConfirmationDialog(
                          ...
                          title: "incomplete_offline_payment".tr,
                          description:
                              "are_you_go_back_incomplete_offline_payment",
                          noButtonText: "cancel".tr,
                          yesButtonText: "yes_go_back",
                          onYesPressed: () {
                            Get.offAllNamed(RouteHelper.getMainRoute('home'));
                        ...
                        : Padding(
                            ...
                            child: Column(children: [
                              ...
                              Padding(
                                ...
                                child: Text('pay_your_bill_using_the_info'.tr,
                                                      ...
                                                      onTap: () async {
                                                        checkoutController
                                                            .changePaymentMethod(
                                                                offlinePaymentModel:
                                                                    offline);
                                                        checkoutController.initializedOfflinePaymentTextField(
                                                            shouldUpdate: true,
                                                            existingOfflineId:
                                                                widget
                                                                    .offlinePaymentId,
                              ...
                              if (checkoutController.selectedOfflineMethod
                                      ?.paymentInformation !=
                                  null)
                                PaymentInfoWidget(
                                  methodInfo: checkoutController
                                      .selectedOfflineMethod!
                                      .customerInformation,
                                  offlinePaymentId: widget.offlinePaymentId,
                                  offlinePaymentData: widget.offlinePaymentData,
                                ),
                              SizedBox(
  ...
  void submitData(CheckOutController checkoutController) {
    if (checkoutController.formKey.currentState!.validate()) {
      ...
      for (int i = 0;
          i <
              checkoutController
                  .selectedOfflineMethod!.customerInformation!.length;
          i++) {
        value.addAll({
      ...
      checkoutController.submitOfflinePaymentData(
        ...
        offlinePaymentInfo: base64Url.encode(utf8.encode(
            jsonEncode(checkoutController.offlinePaymentInputFieldValues))),
        isPartialPayment:
            widget.isPartialPayment != null ? widget.isPartialPayment! : 0,
...
class _PaymentInfoWidgetState extends State<PaymentInfoWidget> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding:
          const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeEight),
                ...
                children: [
                  GridView.builder(
                    ...
                    itemBuilder: (context, index) => CustomTextField(
                      ...
                      title: widget.methodInfo?[index].fieldName
                              ?.replaceAll("_", " ")
                              .capitalizeFirst ??
                          "",
                      hintText: widget.methodInfo?[index].placeholder
                              ?.replaceAll("_", " ")
                              .capitalizeFirst ??
                          "",
                      controller:
                          checkoutController.offlinePaymentInputField[index],
                      onValidate: widget.methodInfo?[index].isRequired == 1
                          ? (String? value) {
                              return FormValidation().validateDynamicTextFiled(
                                  value!,
