import 'package:Vfix4u/feature/checkout/widget/choose_booking_type_widget.dart';
import 'package:Vfix4u/feature/checkout/widget/order_details_section/create_account_widget.dart';
import 'package:Vfix4u/feature/checkout/widget/order_details_section/repeat_booking_schedule_widget.dart';
...
class OrderDetailsPageWeb extends StatelessWidget {
  ...
  const OrderDetailsPageWeb(
      {super.key, required this.pageState, required this.addressId});
        ...
        return GetBuilder<LocationController>(builder: (locationController) {
          return GetBuilder<SplashController>(builder: (splashController) {
            return GetBuilder<CartController>(builder: (cartController) {
              ...
              bool createGuestAccount = splashController
                      .configModel.content?.createGuestUserAccount ==
                  1;
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  (cartController.cartList.isNotEmpty &&
                                          cartController
                                                  .cartList.first.provider !=
                                              null)
                                      ? ProviderDetailsCard(
                                          providerData: cartController
                                              .cartList.first.provider,
                                        )
                                      : const SizedBox(),
                                  const SizedBox(
