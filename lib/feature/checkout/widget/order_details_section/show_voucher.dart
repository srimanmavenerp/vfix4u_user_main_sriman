  ...
  Widget build(BuildContext context) {
    return GetBuilder<ScheduleController>(builder: (scheduleController) {
      return GetBuilder<CartController>(builder: (cartController) {
        bool couponApplied = cartController.cartList.isNotEmpty &&
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        InkWell(
                            ...
                            child: Image.asset(Images.editButton,
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Row(
                            children: [
                              Image.asset(Images.appliedCouponPercentIcon,
                                  height: 20, width: 20),
                              const SizedBox(
                          ...
                          GetBuilder<CouponController>(
                            ...
                            return InkWell(
                                onTap: couponController.isLoading
                                    ? null
                                    : () async {
                                        await Get.find<CouponController>()
                                            .removeCoupon(fromCheckout: true);
