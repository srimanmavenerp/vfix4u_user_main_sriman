...
class BottomNavScreen extends StatefulWidget {
  ...
  const  BottomNavScreen({super.key, required this.pageIndex, this.previousAddress, required this.showServiceNotAvailableDialog, required this.initialBookingTab,});
