      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
                  ...
                  itemBuilder: (context, index) {
                    return InkWell(
                      onTap: () => searchController
                          .updateSortBy(searchController.sortBy[index]),
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: searchController.sortBy[index] ==
                                  searchController.selectedSortBy
                              ? Theme.of(context)
                                  .colorScheme
                                  .primary
                        ...
                        child: Center(
                            child: Text(
                          searchController.sortBy[index].tr,
            ...
            ListView.builder(
              itemBuilder: (context, index) {
                return RadioListTile(
                  ...
                  title: Text(searchController.sortByType[index].tr,
                      style: robotoRegular.copyWith(
                          fontSize: Dimensions.fontSizeDefault,
                          color:
                  ...
                  onChanged: (val) {
                    searchController
                        .updateSortByType(searchController.sortByType[index]);
                  },
                );
              },
            ...
            Row(
              children: [
                (searchController.selectedSortBy != null ||
                        searchController.selectedSortByType != "default")
                    ? Expanded(
                        child: CustomButton(
                          buttonText: 'clear_sorting'.tr,
