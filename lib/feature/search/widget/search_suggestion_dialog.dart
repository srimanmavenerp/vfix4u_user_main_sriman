...
import 'package:Vfix4u/feature/search/widget/realtime_search_suggestion.dart';
...
class SearchSuggestionDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AllSearchController>(builder: (searchController) {
      return Container(
        margin:
            EdgeInsets.only(top: ResponsiveHelper.isDesktop(context) ? 0 : 72),
