      ...
      return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Expanded(
            ...
            style:
                robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge - 1),
          ...
          serviceController.recommendedSearchList != null &&
              ...
              ? const SizedBox()
              : InkWell(
                  onTap: () => serviceController.recommendedSearchList == null
                      ? null
                            ...
                            child: InkWell(
                              ...
                              onTap: () {
                                ...
                                Get.toNamed(RouteHelper.getSearchResultRoute(
                                    queryText: serviceController
                                            .recommendedSearchList?[index]
                                            .name ??
                                        ''));
                                Get.find<AllSearchController>()
                                    .populatedSearchController(serviceController
                                            .recommendedSearchList?[index]
                                            .name ??
                                        '');
                              },
                              child: Text(
                                serviceController
                                        .recommendedSearchList?[index].name ??
                                    "",
