...
import 'package:Vfix4u/feature/search/widget/already_filtered_widget.dart';
import 'package:Vfix4u/feature/search/widget/service_filter_dialog.dart';
import 'package:Vfix4u/feature/search/widget/service_sort_dialog.dart';
                    ...
                    : InkWell(
                        onTap: () {
                          showModalBottomSheet(
                            ...
                            context: context,
                            builder: (context) => const ServiceSortDialog(),
                          );
                        },
                        child: Container(
                          decoration: BoxDecoration(
                          ...
                          return ["Menu"].map((String option) {
                            return PopupMenuItem<String>(
                              ...
                              child: ConstrainedBox(
                                  constraints: BoxConstraints(
                                      maxHeight: Get.height * 0.7),
                                  child: const ServiceFilterDialog(
                                      showCrossButton: false)),
                            );
                          }).toList();
                        },
                                    ...
                                    Positioned(
                                      ...
                                      child: Container(
                                        ...
                                        child: Center(
                                          child: FittedBox(
                                            child: Text(
                                              '${searchController.filteredByList.length}',
                                              style: robotoBold.copyWith(
                                                  color: Colors.white),
                                            ),
                                          ),
