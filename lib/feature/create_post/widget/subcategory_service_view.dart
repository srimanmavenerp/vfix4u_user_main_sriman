    ...
    Get.find<CategoryController>()
      ...
      Get.find<ServiceController>().getSubCategoryBasedServiceList(
        Get.find<CategoryController>().subCategoryList != null &&
                Get.find<CategoryController>().subCategoryList!.isNotEmpty
            ? Get.find<CategoryController>().subCategoryList![0].id!
            : "",
        showShimmerAlways: true,
      );
      tabController = TabController(
          length: Get.find<CategoryController>().subCategoryList?.length ?? 0,
          vsync: this);
    });
  }
                                                                  ...
                                                                  discountModel
                                                                      ...
                                                                      ? Directionality(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            style:
                                                                                robotoMedium.copyWith(fontSize: Dimensions.paddingSizeDefault, color: Get.isDarkMode ? Theme.of(context).primaryColorLight : Theme.of(context).primaryColor),
                                                                          ),
                                                                        )
                                                                      : Directionality(
                                                                          textDirection:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            PriceConverter.convertPrice(lowestPrice.toDouble()),
                                                                            style:
                                                                                robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Get.isDarkMode ? Theme.of(context).primaryColorLight : Theme.of(context).primaryColor),
                                                                          ),
                                                                        ),
                                                                ],
                                                              ),
