...
import 'package:Vfix4u/feature/area/widget/my_marker.dart';
...
class AreaMapViewScreen extends StatefulWidget {
  ...
  const AreaMapViewScreen(
      {super.key, required this.zoneList, this.onValueChanged});
  @override
                ...
                MouseRegion(
                  ...
                  child: GoogleMap(
                    initialCameraPosition:
                        CameraPosition(target: _initialPosition!, zoom: 4),
