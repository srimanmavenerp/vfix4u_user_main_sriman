...
class UserRepo extends DataSyncRepo {
  ...
  Future<ApiResponseModel<T>> getUserInfo<T>(
  ...
  Future<ApiResponseModel<T>> getCategoryList<T>(
    ...
    return await fetchData<T>(
        '${AppConstants.categoryUrl}&limit=100&offset=1', source);
  }
  ...
  Future<Response> updateProfile(
    ...
    return await apiClient.postMultipartData(AppConstants.updateProfileUri,
        body, data != null ? [MultipartBody('profile_image', data)] : []);
  }
