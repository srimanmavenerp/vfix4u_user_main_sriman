        ...
        body: GetBuilder<NotificationController>(
          ...
          builder: (controller) {
            return FooterBaseView(
                ...
                isCenter:
                    Get.find<NotificationController>().notificationList.isEmpty
                        ? true
                        : false,
                child: WebShadowWrap(
                  child: SizedBox(
                        ...
                        : controller.notificationModel != null &&
                            ...
                            : PaginatedListView(
                                ...
                                totalSize: controller
                                    .notificationModel!.content!.total!,
                                ...
                                offset: controller
                                    .notificationModel?.content?.currentPage,
                                                          ...
                                                          Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              SizedBox(
                                                                  height: 40,
                                                                  width: 60,
                                                                  child: Text(DateConverter.convertStringTimeToDate(DateConverter.isoUtcStringToLocalDate(controller
                                                                      .notificationList[
                                                                          index0]
                                                                          [
                                                                          index1]
