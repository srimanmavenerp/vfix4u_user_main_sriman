import 'package:Vfix4u/common/widgets/ldashed_line_printer.dart';
import 'package:get/get.dart';
import 'package:Vfix4u/feature/review/controller/submit_review_controller.dart';
import 'package:Vfix4u/feature/review/widgets/select_rating.dart';
  ...
  _loadData() async {
    if (widget.id != null) {
      Get.find<BookingDetailsController>()
          .getBookingDetails(bookingId: widget.id!);
                      ...
                      children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  image: DecorationImage(
                                      fit: BoxFit.fill,
                                      image:
                                          AssetImage(Images.reviewTopBanner))),
                            ),
                            SizedBox(
                              height: ResponsiveHelper.isDesktop(context)
                                  ? 280
                        ...
                        !ResponsiveHelper.isDesktop(context)
                            ? ReviewBookingDetailsCard(
                                bookingDetailsContent:
                                    bookingController.bookingDetailsContent!)
                            : const SizedBox(),
                        ListView.builder(
                          itemBuilder: (context, index) {
                            ...
                            Get.find<BookingDetailsController>()
                              ...
                              if (submitReviewController
                                      .serviceReviewList?[index].id ==
                                  bookingDetailsItem.serviceId) {
                                variationList
                                    .add(bookingDetailsItem.variantKey ?? "");
                              }
                            });
                            String variations =
                                variationList.toString().replaceAll('[', '');
                            ...
                            return Padding(
                              ...
                              child: submitReviewController.isEditable[
                                      submitReviewController
                                          .serviceReviewList?[index].id!]!
                                  ? EditableReview(
                                      serviceReview: submitReviewController
                          ...
                          itemCount:
                              submitReviewController.serviceReviewList?.length,
                        ),
                        const SizedBox(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text(
                DateConverter.formatDate(DateConverter.isoUtcStringToLocalDate(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              const SizedBox(),
              SelectRating(
                revivedId: widget.serviceReview!.id!,
              ),
              const SizedBox()
            ],
          ),
          ...
          CustomButton(
            ...
            width: ResponsiveHelper.isDesktop(context)
                ...
                : ResponsiveHelper.isTab(context)
                    ...
                    : 120,
            radius: 50,
            isLoading: submitReviewController.selectedIndex == widget.index &&
                submitReviewController.isLoading,
            buttonText: 'submit'.tr,
            onPressed: () {
              String review = submitReviewController
                  .textControllers[widget.serviceReview?.id!]!.value.text;
              ...
              submitReviewController.submitReview(
                  reviewBody, widget.serviceReview!.id!, review, widget.index);
            },
          )
        ],
      );
      ...
      return Stack(children: [
        Column(
          children: [
            ...
            submitReviewController.reviewComments[serviceReview!.id]!.isNotEmpty
                ? Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (reviewReply != null &&
                            submitReviewController
                                .reviewComments[serviceReview!.id]!.isNotEmpty)
                          Padding(
