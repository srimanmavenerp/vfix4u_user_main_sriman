...
class AllFeatheredCategoryServiceView extends StatefulWidget {
  ...
  const AllFeatheredCategoryServiceView(
      {super.key, this.fromPage, this.categoryId});

  @override
  State<AllFeatheredCategoryServiceView> createState() =>
      _AllFeatheredCategoryServiceViewState();
}

class _AllFeatheredCategoryServiceViewState
    extends State<AllFeatheredCategoryServiceView> {
      ...
      body: FooterBaseView(
        child: GetBuilder<ServiceController>(builder: (serviceController) {
          ...
          return serviceController.categoryList != null &&
                  serviceController.categoryList!.isNotEmpty
              ? SizedBox(
