...
import 'package:Vfix4u/feature/service/model/recommendation_search_model.dart';
...
class ServiceController extends GetxController implements GetxService {
    ...
    if (offset != 1 || _allService == null || reload) {
      if (offset == 1) {
        ...
        if (response.response.statusCode == 200) {
          ...
          _serviceContent =
              ServiceModel.fromJson(response.response.body).content;
      ...
      if (offset == 1) {
        ...
        if (response.response.statusCode == 200) {
          ...
          _popularBasedServiceContent =
              ServiceModel.fromJson(response.response).content;
    ...
    if (offset != 1 || _recentlyViewServiceList == null || reload) {
      if (offset == 1) {
        ...
        ApiResponseModel response =
            await serviceRepo.getRecentlyViewedServiceList(
                offset: offset, source: DataSourceEnum.client);
        if (response.response.statusCode == 200) {
          if (reload) {
            _recentlyViewServiceList = [];
  ...
  Future<void> getFeatherCategoryList(bool reload) async {
    if (_featheredCategoryContent == null || reload) {
      ...
      DataSyncHelper.fetchAndSyncData(
        ...
        onResponse: (data, source) {
          _featheredCategoryContent =
              FeatheredCategoryModel.fromJson(data).content;
  ...
  Future<void> getSubCategoryBasedServiceList(String subCategoryID,
