...
void customCouponSnackBar(String? title,
    {String? subtitle,
    bool isError = true,
  ...
  if (title != null && title.isNotEmpty) {
    ...
    Get.snackbar(
      ...
      messageText: Text(
        subtitle?.tr ?? "",
        style:
            robotoRegular.copyWith(color: Colors.white.withValues(alpha: 0.7)),
      ),
      ...
      icon: Image.asset(isError ? Images.couponWarning : Images.correctIcon,
      ...
      margin: ResponsiveHelper.isDesktop(Get.context!)
          ? EdgeInsets.only(
              ...
              right: (width - Dimensions.webMaxWidth) / 2)
