...
class _CouponScreenState extends State<CouponScreen>
  ...
  initState() {
    ...
    Get.find<CouponController>()
        .updateSelectedCouponIndex(index: -1, shouldUpdate: false);
                                ...
                                Expanded(
                                  child: TabBarView(
                                      ...
                                      children: [
                                        ...
                                        _couponList(context, expiredCouponList,
                                            isExpired: true)
                                      ]),
                                ),
                              if (ResponsiveHelper.isWeb())
    ...
    return couponList.isNotEmpty
        ? GridView.builder(
            ...
            gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
              ...
              mainAxisExtent:
                  Get.find<LocalizationController>().isLtr ? 135 : 162,
            ),
            itemBuilder: (context, index) {
              final couponModel = couponList[index];
              print('couponModel Model: ${couponModel.discount!.minPurchase}');

              if (couponModel.discount != null) {
                print('Discount Model: ${couponModel.discount}');
              } else {
                print('No discount found in coupon.');
              }
