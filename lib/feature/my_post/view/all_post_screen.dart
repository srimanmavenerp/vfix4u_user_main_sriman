...
import 'package:Vfix4u/feature/my_post/widgets/my_post_view.dart';
                      ...
                      children: [
                        Center(
                          ...
                          child: ConstrainedBox(
                            constraints:
                                BoxConstraints(minHeight: Get.height * 0.8),
                            child: GetBuilder<CreatePostController>(
                              ...
                              return (!createPostController.isLoading &&
                                      createPostController.dateList.isNotEmpty)
                                  ? PaginatedListView(
                                      scrollController: scrollController,
                                      totalSize: createPostController
                                          .postModel?.content?.total,
                                      onPaginate: (int offset) async =>
                                          await createPostController
                                              .getMyPostList(offset,
                                                  reload: false),
                                      offset: createPostController
                                          .postModel?.content?.currentPage,
