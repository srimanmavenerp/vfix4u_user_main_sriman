...
class ProviderOfferListScreen extends StatefulWidget {
  ...
  const ProviderOfferListScreen(
      {super.key, this.postId, this.myPostData, this.status});
...
class _ProviderOfferListScreenState extends State<ProviderOfferListScreen> {
  ...
  void initState() {
    ...
    Get.find<CreatePostController>()
        .getProvidersOfferList(1, widget.postId ?? "", reload: true);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<CreatePostController>(builder: (createPostController) {
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: ConstrainedBox(
                          constraints:
                              BoxConstraints(minHeight: Get.height * 0.6),
                          child:
                              createPostController.providerOfferModel != null &&
                                      createPostController
                                              .providerOfferModel!.content !=
                                          null &&
                                      createPostController
                                              .listOfProviderOffer !=
                                          null &&
                                      createPostController
                                          .listOfProviderOffer!.isNotEmpty
                                  ? Padding(
