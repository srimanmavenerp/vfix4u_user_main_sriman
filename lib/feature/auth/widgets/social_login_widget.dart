...
import 'package:Vfix4u/feature/auth/widgets/social_login_button.dart';
...
class SocialLoginWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool isOnlySocialLogin = config?.loginOption?.manualLogin == 0 &&
                    ...
                    return socialLoginOption.length <= 2
                        ? Expanded(
                            child: SocialLoginButton(
                              ...
                              fromPage: fromPage,
                              showPadding: (socialLoginOption.length - 1) !=
