...
class ConversationRepo {
  ...
  Future<Response> searchChannelList({String? queryText}) async {
    return await apiClient.postData(AppConstants.searchChannelListUrl,
        {"limit": "50", "offset": "1", "search": queryText});
  }
  ...
  Future<Response> sendMessage(String? message, String channelID,
      List<MultipartBody>? file, List<PlatformFile>? platformFile) async {
