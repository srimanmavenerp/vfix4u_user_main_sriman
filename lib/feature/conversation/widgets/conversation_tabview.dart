          ...
          children: [
            TabBar(
              ...
              labelPadding: EdgeInsets.only(
                right: conversationController.isActiveSuffixIcon &&
                        conversationController.isSearchComplete &&
                        conversationController
                            .searchedProviderChannelList!.isNotEmpty
                    ? 10
                    : 25,
              ),
              tabs: [
                        ...
                        conversationController.isActiveSuffixIcon &&
                            ...
                            ? Container(
                                ...
                                child: FittedBox(
                                  child: Text(
                                    conversationController
                                        .searchedProviderChannelList!.length
                                        .toString(),
                    ...
                    child: Row(
                      children: [
                        ...
                        conversationController.isActiveSuffixIcon &&
                                conversationController.isSearchComplete &&
                                conversationController
                                    .searchedServicemanChannelList!.isNotEmpty
                            ? Container(
                                height: 15,
                                width: 15,
                                decoration: BoxDecoration(
