  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<ConversationController>(
      ...
      bool isSameUserWithPreviousMessage =
          conversationController.isSameUserWithPreviousMessage(
              widget.previousConversationData, widget.conversationData);
      bool isSameUserWithNextMessage =
          conversationController.isSameUserWithNextMessage(
              widget.conversationData, widget.nextConversationData);
                                      ...
                                      child: CustomImage(
                                        ...
                                        width:
                                            Dimensions.paddingSizeExtraLarge +
                                                5,
                                        image: widget.image,
                                        placeholder: widget.conversationData
                                                    .user!.userType ==
                                                "super-admin"
                          ...
                          Flexible(
                            child: Column(
                                ...
                                children: [
                                    ...
                                    Flexible(
                                      ...
                                      decoration: BoxDecoration(
                                        color: widget.isRightMessage
                                            ...
                                            : ColorResources
                                                .getLeftBubbleColor(),
                                        borderRadius: widget.isRightMessage &&
                                                (isSameUserWithNextMessage ||
                                                    isSameUserWithPreviousMessage)
                                            ? BorderRadius.only(
                                  ...
                                  if (widget.conversationData.message != null &&
                                      widget.conversationData.conversationFile!
                                          .isNotEmpty)
                                    const SizedBox(
                                                                ...
                                                                child: InkWell(
                                                                  onTap: () {
                                                                    Get.to(
                                                                      ImageDetailScreen(
                                                                        ...
                                                                        index:
                                                                            index,
                                                                        createdAt: DateConverter.dateMonthYearTime(DateConverter.isoUtcStringToLocalDate(widget
                                                                            .conversationData
                                                                            .createdAt!)),
                                                                        appbarTitle: widget.conversationData.user!.userType ==
                                                                                "super-admin"
                                                                            ? 'admin'.tr
                                                                            : widget.conversationData.user!.userType == "customer"
                                                                                ? "you".tr
                                                                  ...
                                                                  onLongPress:
                                                                    ...
                                                                    conversationController.toggleOnClickImageAndFile(
                                                                        onImageOrFileTimeShowID: widget
                                                                            .conversationData
                                                                            .id!);
                                                                  },
                                                                  child: Hero(
                                                                    ...
                                                                    child: Stack(
                                                                        children: [
                                                                          ...
                                                                          Container(
                                                                              decoration: BoxDecoration(color: Colors.black.withValues(alpha: 0.6), borderRadius: BorderRadius.circular(Dimensions.radiusLarge))),
                                                                          Positioned.fill(
                                                                              child: Center(
                                                                            child:
                                                                                Text(
                                                                ...
                                                                onTap:
                                                                  ...
                                                                  if (ResponsiveHelper
                                                                    ...
                                                                    Get.find<
                                                                            ConversationController>()
                                                                        .downloadFileForWeb(
                                                                      widget.conversationData.conversationFile![index]
                                                                              .storedFileNameFullPath ??
                                                                          '',
                                                                    );
                                                                  }
                                                                              ...
                                                                              Expanded(
                                                                                child: Column(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Text("${fileList[index].filSize}", style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).hintColor)),
                                                                                  ],
                                                                                ),
                                                                              )
                                                                            ],
