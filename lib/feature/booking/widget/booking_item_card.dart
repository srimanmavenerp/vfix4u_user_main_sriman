        ...
        return GetBuilder<BookingDetailsController>(
          ...
          return Container(
            decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: const Color(0xffFEFEFE).withValues(alpha: 0.1),
                    width: 0.5),
              ...
              children: [
                              ...
                              onTap: () async {
                                ...
                                if (option.title == "rebook") {
                                  serviceBookingController
                                      .updateRebookIndex(index);

                                  await serviceBookingController
                                      .checkCartSubcategory(bookingModel.id!,
                ...
                Row(
                  ...
                  children: [
                    ...
                    if (bookingModel.isPaid == 0 &&
                        bookingStatus != "canceled" &&
                        bookingModel.paymentMethod == "cash_after_service")
                      ElevatedButton(
                        onPressed: () {
                          debugPrint(
                              "Booking ID: ${bookingModel.id.toString()}");
                          bookingDetailsController
                              .showCustomPayViaOnlineDialog(bookingModel.id);
                        },
                        child: Text("Pay"),
                      ),
                    Directionality(
