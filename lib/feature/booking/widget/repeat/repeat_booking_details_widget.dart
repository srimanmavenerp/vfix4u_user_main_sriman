...
import 'package:Vfix4u/feature/booking/widget/repeat/all_booking_summary_widget.dart';
import 'package:Vfix4u/feature/booking/widget/repeat/next_service_widget.dart';
import 'package:Vfix4u/feature/booking/widget/repeat/repeat_booking_info_widget.dart';
import 'package:Vfix4u/feature/booking/widget/repeat/repeat_booking_summary_widget.dart';
import 'package:Vfix4u/feature/booking/widget/repeat/schedule_widget.dart';
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                ResponsiveHelper.isDesktop(context)
                    ...
                    : Column(children: [
                        ...
                        const SizedBox(height: Dimensions.paddingSizeLarge),
                        nextBooking != null
                            ? NextServiceWidget(booking: nextBooking)
                            : const SizedBox(),
                        const SizedBox(height: Dimensions.paddingSizeLarge),
...
class _DesktopView extends StatelessWidget {
  ...
  final TabController tabController;
  const _DesktopView(
      {required this.bookingDetails, required this.tabController});
              ...
              child: Column(children: [
                IntrinsicHeight(
                  child: Row(children: [
                    ...
                    nextBooking != null
                        ? Expanded(
                            child: NextServiceWidget(booking: nextBooking))
                        : const SizedBox(),
                  ]),
                ),
                const SizedBox(height: Dimensions.paddingSizeLarge),
