...
class RebookWarningBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ServiceBookingController>(
      ...
      ServiceAvailabilityModel? serviceAvailable =
          serviceBookingController.serviceAvailability;
      return Container(
        width:
            ResponsiveHelper.isDesktop(context) ? 550 : Dimensions.webMaxWidth,
        padding:
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: Dimensions.paddingSizeLarge),
            Text("provider_not_available".tr,
                style: robotoMedium.copyWith(
                    fontSize: Dimensions.fontSizeExtraLarge),
                textAlign: TextAlign.center),
            const SizedBox(height: Dimensions.paddingSizeLarge),
            Text("the_provider_who_previously".tr,
            ...
            Row(children: [
              ...
              Expanded(
                  child: CustomButton(
                      ...
                      onPressed: () {
                        if (serviceBookingController.isNotAvailable ||
                          ...
                          if (ResponsiveHelper.isDesktop(Get.context)) {
                            Get.dialog(Center(
                              ...
                              isPriceChanged:
                                  serviceBookingController.isPriceChanged,
                              isNotAvailable:
                                  serviceBookingController.isNotAvailable,
                              isAllNotAvailable: serviceBookingController
                                  .checkAllServiceAvailable(
                                      serviceAvailable!.content!.services),
                            )));
                          } else {
                            Get.bottomSheet(
                          ...
                          serviceBookingController.rebook(bookingId,
                              isBack: true);
                        }
                      })),
              const SizedBox(width: Dimensions.paddingSizeDefault),
