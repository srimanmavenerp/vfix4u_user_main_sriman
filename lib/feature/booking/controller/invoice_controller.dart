...
import 'package:Vfix4u/helper/date_converter.dart';
import 'package:Vfix4u/feature/booking/controller/booking_details_controller.dart';
import 'package:Vfix4u/feature/booking/model/booking_details_model.dart';
import 'package:Vfix4u/feature/booking/model/invoice.dart';
...
class InvoiceController {
  static Future<Uint8List> generateUint8List(
    ...
    var invoice = Invoice(
      ...
      info: InvoiceInfo(
        ...
        paymentStatus: bookingDetailsContent.partialPayments != null &&
  ...
  static Widget buildProviderSection(
          Provider provider, ServicemanInvoice serviceman) =>
      Column(
  ...
  static Widget buildTotal(BookingDetailsContent bookingDetailsContent,
      BookingDetailsController controller, String paymentStatus) {
                    ...
                    ? Column(children: [
                        buildText(
                          ...
                          value: double.tryParse(controller
                                  .bookingDetailsContent!.totalBookingAmount
                                  .toString())!
                              .toStringAsFixed(2),
                          unite: true,
                        ),
