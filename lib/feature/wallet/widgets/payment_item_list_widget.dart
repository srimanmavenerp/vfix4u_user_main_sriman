                      ...
                      child: IntrinsicWidth(
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            contentPadding:
                                const EdgeInsets.only(bottom: kIsWeb ? 3 : 0),
                          ),
                          style: robotoBold.copyWith(
                              fontSize: 20,
                              color: Theme.of(context)
                    ...
                    child: paymentMethodList.isNotEmpty
                        ? ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              bool isSelected = paymentMethodList.length == 1 ||
                ...
                ? CustomButton(
                    ...
                    onPressed: () {
                      if (inputAmountController.text.isEmpty) {
                        ...
                        double? amount = double.tryParse(inputAmountController
                            .text
                            .replaceAll(PriceConverter.getCurrency(), ''));
