...
class WalletListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (transactionData.toUserAccount != null &&
        transactionData.toUserAccount == "balance_pending") {
    ...
    double transactionAmount =
        transactionData.debit != null && transactionData.debit != 0
                ...
                Container(
                  ...
                  child: Row(
                      ...
                      children: [
                        ...
                        Text.rich(
                          TextSpan(
                            text: transactionData.debit != 0
                                ? "- ${PriceConverter.convertPrice(transactionAmount).replaceAll("-", "")}"
                                : "+ ${PriceConverter.convertPrice(transactionAmount)}",
                            style: robotoBold.copyWith(
                              fontSize: Dimensions.fontSizeLarge,
                              color: transactionData.debit != 0
