        ...
        child: Container(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              Container(
                ...
                decoration: BoxDecoration(
                    color:
                        Theme.of(Get.context!).hintColor.withValues(alpha: 0.2),
                    borderRadius:
              ...
              Image.asset(
                widget.providerId != null
                    ? Images.favoriteProvider
                    : Images.favoriteService,
                height: 70,
              ...
              Padding(
                ...
                child: Text(
                  widget.providerId != null
                      ? "want_to_remove_provider".tr
                      : widget.serviceId != null
                          ? "want_to_remove_service".tr
                          : "",
                  style:
              ...
              Padding(
                ...
                child: Text(
                  widget.providerId != null
                      ? "provider_remove_message".tr
                      : widget.serviceId != null
                          ? "service_remove_message".tr
                          : "",
                  maxLines: 3,
                    ...
                    Expanded(
                      ...
                      onPressed: () async {
                        ...
                        if (widget.serviceId != null) {
                          await Get.find<MyFavoriteController>()
                              .removeFavoriteService(widget.serviceId!);
                        } else if (widget.providerId != null) {
                          await Get.find<MyFavoriteController>()
                              .removeFavoriteProvider(widget.providerId!);
                        } else {
                          Get.back();
                        }
                        Get.back();
