...
import 'package:Vfix4u/feature/favorite/widget/favorite_service_item_view.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<MyFavoriteController>(builder: (myFavoriteController) {
      return RefreshIndicator(
        ...
        child: myFavoriteController.favoriteServiceList != null &&
                myFavoriteController.favoriteServiceList!.isNotEmpty
            ? PaginatedListView(
                scrollController: scrollController,
                totalSize: myFavoriteController.serviceContent?.total,
                offset: myFavoriteController.serviceContent?.currentPage,
                onPaginate: (int offset) async => await myFavoriteController
                    .getFavoriteServiceList(offset, false),
                bottomPadding: 0,
                itemView: Expanded(
                  child: GridView.builder(
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      ...
                      crossAxisCount: ResponsiveHelper.isMobile(context)
                          ...
                          : ResponsiveHelper.isTab(context)
                              ...
                              : 3,
                      mainAxisExtent:
                          ResponsiveHelper.isMobile(context) ? 140 : 150,
                    ),
                    ...
                    itemBuilder: (context, index) {
                      Discount? discount = PriceConverter.discountCalculation(
                          myFavoriteController.favoriteServiceList![index]);
                      return FavoriteServiceItemView(
                        service:
                            myFavoriteController.favoriteServiceList?[index],
                        index: index,
            ...
            : myFavoriteController.favoriteServiceList != null &&
                    myFavoriteController.favoriteServiceList!.isEmpty
                ? Padding(
                    padding: EdgeInsets.only(bottom: Get.height * 0.15),
                    child: const NoDataScreen(
                      text: "you_have_not_any_favorite_services",
