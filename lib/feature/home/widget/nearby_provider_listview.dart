    ...
    return GetBuilder<NearbyProviderController>(
      ...
      return providerBookingController.providerList != null &&
                    ...
                    child: Column(children: [
                      ...
                      Padding(
                        ...
                        child: TitleWidget(
                          ...
                          onTap: () => Get.toNamed(
                              RouteHelper.getNearByProviderScreen(tabIndex: 0)),
                        ),
                      ),
                      SizedBox(
                        height: ResponsiveHelper.isMobile(context) ? 140 : 150,
                        child: ListView.builder(
                          ...
                          itemCount:
                              providerBookingController.providerList?.length,
          ...
          : providerBookingController.providerList != null &&
              ...
              ? const SizedBox()
              : HomeRecommendedProviderShimmer(
                  height: height,
                );
    });
  }
