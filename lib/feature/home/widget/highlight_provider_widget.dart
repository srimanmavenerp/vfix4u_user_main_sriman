          ...
          ? Container(
              decoration: BoxDecoration(
                ...
                color: Theme.of(context)
                    .colorScheme
                    .primary
                    .withValues(alpha: Get.isDarkMode ? 0.2 : 0.1),
              ),
              child: Stack(
                      ...
                      children: [
                        ...
                        CarouselSlider.builder(
                          options: CarouselOptions(
                            enableInfiniteScroll: advertisementController
...
class AdvertisementVideoPromotionWidget extends StatefulWidget {
  ...
  const AdvertisementVideoPromotionWidget(
      {super.key, required this.advertisement});
              ...
              children: [
                Row(
                  children: [
                    ...
                    InkWell(
                      onTap: () => Get.toNamed(RouteHelper.getProviderDetails(
...
class AdvertisementProfilePromotionWidget extends StatelessWidget {
  ...
  const AdvertisementProfilePromotionWidget(
      {super.key, required this.advertisement, required this.index});
