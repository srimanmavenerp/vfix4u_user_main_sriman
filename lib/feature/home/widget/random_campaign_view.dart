...
import 'package:Vfix4u/helper/help_me.dart';
import 'package:Vfix4u/feature/home/controller/campaign_controller.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CampaignController>(builder: (campaignController) {
      ...
      if (campaignController.campaignList != null &&
        ...
        if (campaignController.campaignList != null) {
          var rng = Random();
          randomIndex = rng.nextInt(campaignController.campaignList!.isNotEmpty
                  ...
                  Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: CustomImage(
                        ...
                        image: campaignController.campaignList![randomIndex]
                                .coverImageFullPath ??
                            "",
                      ),
                    ),
