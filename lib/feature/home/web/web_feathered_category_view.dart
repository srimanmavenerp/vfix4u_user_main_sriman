          ...
          ? SizedBox(
              child: ListView.builder(
                itemBuilder: (context, categoryIndex) {
                  ...
                  serviceItemCount = serviceController
                              .categoryList![categoryIndex]
                              .servicesByCategory!
                              .length >
                          10
                      ? 10
                      : serviceController.categoryList![categoryIndex]
                          .servicesByCategory!.length;

                  return Container(
                    height:
                        Get.find<LocalizationController>().isLtr ? 320 : 330,
                    width: Get.width,
