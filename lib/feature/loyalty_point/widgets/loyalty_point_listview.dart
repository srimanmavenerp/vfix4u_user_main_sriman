  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<LoyaltyPointController>(
      ...
      List<LoyaltyPointTransactionData> listOfTransaction =
          loyaltyPointController.listOfTransaction;
      return Padding(
            ...
            listOfTransaction.isNotEmpty
                ? PaginatedListView(
                    ...
                    totalSize: loyaltyPointController
                        .loyaltyPointModel!.content!.transactions!.total!,
                    onPaginate: (int offset) async =>
                        await loyaltyPointController.getLoyaltyPointData(
                      offset,
                      reload: false,
                    ),
                    offset: loyaltyPointController
                        .loyaltyPointModel!.content!.transactions?.currentPage,
                    itemView: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return LoyaltyPointItemView(
                          transactionData: listOfTransaction[index],
                        );
                      },
                    ),
                  )
