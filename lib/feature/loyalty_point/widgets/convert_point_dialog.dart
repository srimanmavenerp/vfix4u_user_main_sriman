      ...
      child: SizedBox(
          ...
          child: Padding(
            ...
            child: SingleChildScrollView(child:
                GetBuilder<LoyaltyPointController>(
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            style: robotoBold.copyWith(
                                fontSize: Dimensions.fontSizeLarge),
                            controller:
                                loyaltyPointController.loyaltyPointController,
                      ...
                      Row(
                        children: [
                          ...
                          Directionality(
                            ...
                            child: Text(
                              ' ${loyaltyPointController.loyaltyPointModel?.content?.loyaltyPoint?.toStringAsFixed(2) ?? 0}',
                              style: robotoRegular.copyWith(
                                  color: Get.isDarkMode
                                      ? Colors.white70
                                      : Theme.of(context).primaryColor,
                    ...
                    children: [
                      Padding(
                          padding: const EdgeInsets.fromLTRB(
                              0, 0, 0, Dimensions.paddingSizeSmall),
                          child: Text(
                            'note'.tr,
                            style: robotoMedium.copyWith(
                                fontSize: Dimensions.fontSizeLarge,
                    ...
                    ? CustomButton(
                        ...
                        onPressed: () {
                          double inputAmount = double.tryParse(
                              ...
                              0;
                          double availAblePoint = loyaltyPointController
                                  .loyaltyPointModel?.content?.loyaltyPoint ??
                              0;
                          double minimumConvertAblePoint = double.tryParse(
                                  loyaltyPointController
                                          .loyaltyPointModel
                                          ?.content
                                          ?.minLoyaltyPointToTransfer ??
                                      "0") ??
                              0;

                          if (loyaltyPointController
                              .loyaltyPointController.text.isEmpty) {
                            ...
                            customSnackBar(
                                '${"minimum_convert_able_point".tr} $minimumConvertAblePoint'
                                    .tr);
                          } else {
