...
class LoyaltyPointScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<LoyaltyPointController>(initState: (_) {
      ...
      bottomSheet:
          GetBuilder<LoyaltyPointController>(builder: (loyaltyPointController) {
        if (!ResponsiveHelper.isDesktop(context) &&
            Get.find<LoyaltyPointController>().loyaltyPointModel != null) {
          return SizedBox(
            height: 60,
            width: Get.width,
            child: CustomButton(
