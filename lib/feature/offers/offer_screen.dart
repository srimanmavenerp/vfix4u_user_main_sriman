                    ...
                    child: Column(
                      children: [
                        !ResponsiveHelper.isMobile(context) &&
                                serviceController.offerBasedServiceList !=
                                    null &&
                                serviceController
                                    .offerBasedServiceList!.isNotEmpty
                            ? Padding(
                        ...
                        PaginatedListView(
                          scrollController: scrollController,
                          totalSize:
                              serviceController.offerBasedServiceContent?.total,
                          offset: serviceController
                              .offerBasedServiceContent?.currentPage,
                          onPaginate: (int offset) async =>
                              await serviceController.getOffersList(
                                  offset, false),
