...
import 'package:Vfix4u/feature/suggest_new_service/model/suggest_service_model.dart';
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              ? Row(
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Text(suggestedService.category?.name ?? "",
          ...
          Padding(
            padding: const EdgeInsets.fromLTRB(0, Dimensions.paddingSizeDefault,
                0, Dimensions.paddingSizeTine),
            child: Text("suggested_service".tr,
                style: robotoMedium.copyWith(
          ...
          Text(suggestedService.serviceName ?? "",
              style:
          ...
          Text(
            ...
            maxLines: 100,
            overflow: TextOverflow.ellipsis,
            textAlign: Get.find<LocalizationController>().isLtr
                ? TextAlign.justify
                : TextAlign.right,
          ),
        ]),
