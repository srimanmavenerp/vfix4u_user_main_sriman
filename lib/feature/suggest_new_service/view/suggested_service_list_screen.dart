  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<SuggestServiceController>(
          initState: (_) => Get.find<SuggestServiceController>()
              .getSuggestedServiceList(1, reload: true),
                        ...
                        child: Column(
                            ...
                            children: [
                              if (suggestServiceController
                                  .suggestedServiceList.isNotEmpty)
                                Padding(
                              ...
                              suggestServiceController
                                      .suggestedServiceList.isNotEmpty
                                  ? ListView.builder(
                                      itemCount: suggestServiceController
                                          .suggestedServiceList.length,
                                      shrinkWrap: true,
                                      physics:
