...
class _ProductBottomSheetState extends State<AvailableProviderWidget> {
  ...
  void initState() {
    ...
    Get.find<CartController>()
        .getProviderBasedOnSubcategory(widget.subcategoryId, true);
  }
          ...
          child: Container(
            ...
            child: providerList != null
                          ...
                          onPressed: () async {
                            await cartController.updateProvider(
                                cartController.selectedProviderIndex != -1
                                    ? cartController.providerList![
                                        cartController.selectedProviderIndex]
                                    : null);
                            Get.back();
                          },
                ...
                : SizedBox(
                    height: 150,
                    width: 50,
                    child: CustomLoaderWidget(color: const Color(0xffFEFEFE))),
          ),
        ),
      );
    });
